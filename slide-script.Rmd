...
install.load::install_load(c("knitr","styler","icons" ,"xaringanExtra", "xaringan", "tidyverse", "kableExtra", "countdown", "janitor"))
...
# Artificial Intelligence and Coding Training
...
.w-100.lh-copy[
Intentionally, in this training we be using learn and use R programming.
]

--

.w-100.lh-copy[
R is user-friendly and easy software tool to efficiently analyse any kind of data data
]
...
.w-100.lh-copy[
The R programming is written in C, Fortran and R itself and allow the integration with Python,C,C++, and JavaScript.
]
...
.w-100.1h-copy[
R Studio makes programming easier and friendly in R.
]
